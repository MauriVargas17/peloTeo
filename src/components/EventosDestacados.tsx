        ...
        {eventosFiltrados.map((evento) => (
          <div key={evento.nombre} className="flex-shrink-0 w-64 rounded-lg overflow-hidden">
            ...
            <div className="bg-white p-4">
              ...
              <button style={{ backgroundColor: '#E21837' }} className="text-white border-2 border-002D62 px-4 py-2 rounded-full hover:bg-red-700 focus:outline-none focus:bg-red-700">
                Ver Detalles
              </button>
            </div>
          </div>
